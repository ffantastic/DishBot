...
namespace testBot.Data
{
    public class QuestionDB
    {
        public const string JsonList = @"[
            {'Id':0,'Content':'您好，欢迎使用DishBot点餐。  \n请问有几位男士几位女士就餐？','Priority':0,'NextId':1}, 
            ...
            {'Id':5,'Content':'有不吃的菜或配料吗？','Priority':5,'NextId':6},
            {'Id':6,'Content':'有哪些？','Priority':100,'NextId':-1},
            {'Id':7,'Content':'你们要几份主食？','Priority':5,'NextId':-1}
            ]";
    }
}